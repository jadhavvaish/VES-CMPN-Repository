...
$sql = "SELECT * FROM upload WHERE Subject='OOPM' AND Category='assignment' ";
...
<a class="nav-link" href="oopmexp.php" >Experiment</a>
  <a class="nav-link mt-2 active" href="oopmass.php"  >Assignment</a>
...
<div class="col-lg-9">
 ...
 <h2 class='mt-3'>OOPM Assignments(2020-21)</h2>
