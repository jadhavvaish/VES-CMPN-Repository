...
$sql = "SELECT * FROM upload WHERE Subject='DSGT' AND Category='assignment' ";
...
<div class="nav flex-column nav-pills col-lg-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
  <a class="nav-link" href="dsgtexp.php" >Experiment</a>
  <a class="nav-link mt-2 active" href="dsgtass.php"  >Assignment</a>
...
<div class="col-lg-9">
 ...
 <h2 class='mt-3'>DSGT Assignments(2020-21)</h2>
