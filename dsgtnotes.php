...
$sql = "SELECT * FROM upload WHERE Subject='DSGT' AND Category='notes'";
...
<div class="nav flex-column nav-pills col-lg-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
  ...
  <a class="nav-link mt-2 active" href="dsgtnotes.php" >Notes</a>
</div>

<!-- Page content -->
<div class="col-lg-9">
 
 <h2 class='mt-3'>DSGT Notes(2020-21)</h2>
